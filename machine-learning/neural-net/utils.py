...
def testmodels(X_tr, y_tr, X_te, y_te, archs, actfn='relu', last_act='softmax', reg_coeffs=[0.0],
	...
	print('\nBest Config: architecture = {0}, lambda = {1}, decay = {2}, momentum = {3}, actfn = {4}, best_acc = {5}\n'.format(best_config[0], best_config[1], best_config[2], best_config[3], best_config[4], best_config[5]))
	return best_config